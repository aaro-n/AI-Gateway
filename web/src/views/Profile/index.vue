<template>
  <div class="profile-page">
    ...
    <el-card class="section-card" shadow="never">
      ...
      <el-form :model="profile" label-width="120px" style="max-width: 480px">
    ...
    <el-card class="section-card" shadow="never">
      ...
      <el-form :model="usernameForm" :rules="usernameRules" ref="usernameFormRef" label-width="140px" style="max-width: 520px">
        ...
        <el-form-item>
          <el-button type="primary" @click="handleSaveUsername" :loading="usernameLoading">
            {{ t('common.save') }}
          </el-button>
        </el-form-item>
      </el-form>

      <el-divider style="margin: 12px 0; max-width: 520px" />

      <el-form :model="passwordForm" :rules="passwordRules" ref="passwordFormRef" label-width="140px" style="max-width: 520px">
